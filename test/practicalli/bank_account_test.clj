...
(def account-holder-mock
  {:account-id
   #uui "97bda55b-6175-4c39-9e04-7c0205c709dc"
   :firstname
   "Jenny"
   :lastname
   "Jetpack"
   :email-address                                                                                             "jenny@jetpack.org"
   :residential-address                                                                                       "42 meaning of life street, Earth"
   https://github.com/practicalli/leveraging-spec/blob/master/src/practicalli/bank_account_design_journal.clj :postal-code "AB3 0EF"})
